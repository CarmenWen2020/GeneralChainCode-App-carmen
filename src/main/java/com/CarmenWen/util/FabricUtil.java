...
public class FabricUtil<T> {
    ...
    static String  CCP = "/Users/carmenw/github.com/CarmenWen2020/fabric-samples/test-network/organizations/peerOrganizations/org1.example.com" +
...
/**
    ...
    public static Contract getContract() throws Exception {
        Contract contract = createContract(walletPath,CCP,"carmenchannel","java_demo01");
        return contract;
    }
