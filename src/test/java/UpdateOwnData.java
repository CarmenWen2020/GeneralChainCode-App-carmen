...
public class UpdateOwnData extends JFrame {
    public static void main(String[] args) {
        UpdateOwnData f = new UpdateOwnData();
...
/*        String name = NameField.getText().trim();
    ...
    private void verifyAccount(String username, String password){
        ...
        try{
            System.out.println("testestusername----->"+username+"password---->"+password);
            ...
            System.out.println("normalQueries------>"+normalQueries);
            ...
            String values = "{\"Credit\":"+jsonObject.get("Credit")+
                    ",\"PaperID\":\""+jsonObject.get("PaperID")+"\""+
                    ",\"PW\":\""+Login.thisPassword+"\""+
...
*/
    ...
    private void ButtonSummitMousePressed(java.awt.event.MouseEvent evt) {
